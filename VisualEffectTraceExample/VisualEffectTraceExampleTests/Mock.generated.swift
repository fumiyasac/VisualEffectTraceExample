...
open class AnnouncementUseCaseMock: AnnouncementUseCase, Mock {
    ...
    open func execute() -> Single<AnnouncementListAPIResponse> {
    ...
    open class Given: StubbedMethod {
        ...
        public static func execute(willReturn: Single<AnnouncementListAPIResponse>...) -> MethodStub {
            return Given(method: .m_execute, products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func execute(willProduce: (Stubber<Single<AnnouncementListAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<AnnouncementListAPIResponse>] = []
...
open class EventIntroductionRepositoryMock: EventIntroductionRepository, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func requestEventIntroductionDataList(page: Int) -> Single<EventIntroductionAPIResponse> {
        addInvocation(.m_requestEventIntroductionDataList__page_page(Parameter<Int>.value(`page`)))
		let perform = methodPerformValue(.m_requestEventIntroductionDataList__page_page(Parameter<Int>.value(`page`))) as? (Int) -> Void
		perform?(`page`)
		var __value: Single<EventIntroductionAPIResponse>
		do {
		    __value = try methodReturnValue(.m_requestEventIntroductionDataList__page_page(Parameter<Int>.value(`page`))).casted()
		} catch {
			onFatalFailure("Stub return value not specified for requestEventIntroductionDataList(page: Int). Use given")
			Failure("Stub return value not specified for requestEventIntroductionDataList(page: Int). Use given")
		}
		return __value
    }
    ...
    fileprivate enum MethodType {
        case m_requestEventIntroductionDataList__page_page(Parameter<Int>)

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_requestEventIntroductionDataList__page_page(let lhsPage), .m_requestEventIntroductionDataList__page_page(let rhsPage)):
				var results: [Matcher.ParameterComparisonResult] = []
				results.append(Matcher.ParameterComparisonResult(Parameter.compare(lhs: lhsPage, rhs: rhsPage, with: matcher), lhsPage, rhsPage, "page"))
				return Matcher.ComparisonResult(results)
            }
        ...
        func intValue() -> Int {
            switch self {
            case let .m_requestEventIntroductionDataList__page_page(p0): return p0.intValue
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_requestEventIntroductionDataList__page_page: return ".requestEventIntroductionDataList(page:)"
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func requestEventIntroductionDataList(page: Parameter<Int>, willReturn: Single<EventIntroductionAPIResponse>...) -> MethodStub {
            return Given(method: .m_requestEventIntroductionDataList__page_page(`page`), products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func requestEventIntroductionDataList(page: Parameter<Int>, willProduce: (Stubber<Single<EventIntroductionAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<EventIntroductionAPIResponse>] = []
			let given: Given = { return Given(method: .m_requestEventIntroductionDataList__page_page(`page`), products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<EventIntroductionAPIResponse>).self)
			willProduce(stubber)
			return given
        }
    ...
    public struct Verify {
        ...
        public static func requestEventIntroductionDataList(page: Parameter<Int>) -> Verify { return Verify(method: .m_requestEventIntroductionDataList__page_page(`page`))}
    }
    ...
    public struct Perform {
        ...
        public static func requestEventIntroductionDataList(page: Parameter<Int>, perform: @escaping (Int) -> Void) -> Perform {
            return Perform(method: .m_requestEventIntroductionDataList__page_page(`page`), performs: perform)
        }
    }
...
open class EventIntroductionUseCaseMock: EventIntroductionUseCase, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func execute(page: Int) -> Single<EventIntroductionAPIResponse> {
        addInvocation(.m_execute__page_page(Parameter<Int>.value(`page`)))
		let perform = methodPerformValue(.m_execute__page_page(Parameter<Int>.value(`page`))) as? (Int) -> Void
		perform?(`page`)
		var __value: Single<EventIntroductionAPIResponse>
		do {
		    __value = try methodReturnValue(.m_execute__page_page(Parameter<Int>.value(`page`))).casted()
		} catch {
			onFatalFailure("Stub return value not specified for execute(page: Int). Use given")
			Failure("Stub return value not specified for execute(page: Int). Use given")
		}
		return __value
    }
    ...
    fileprivate enum MethodType {
        case m_execute__page_page(Parameter<Int>)

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_execute__page_page(let lhsPage), .m_execute__page_page(let rhsPage)):
				var results: [Matcher.ParameterComparisonResult] = []
				results.append(Matcher.ParameterComparisonResult(Parameter.compare(lhs: lhsPage, rhs: rhsPage, with: matcher), lhsPage, rhsPage, "page"))
				return Matcher.ComparisonResult(results)
            }
        ...
        func intValue() -> Int {
            switch self {
            case let .m_execute__page_page(p0): return p0.intValue
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_execute__page_page: return ".execute(page:)"
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func execute(page: Parameter<Int>, willReturn: Single<EventIntroductionAPIResponse>...) -> MethodStub {
            return Given(method: .m_execute__page_page(`page`), products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func execute(page: Parameter<Int>, willProduce: (Stubber<Single<EventIntroductionAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<EventIntroductionAPIResponse>] = []
			let given: Given = { return Given(method: .m_execute__page_page(`page`), products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<EventIntroductionAPIResponse>).self)
			willProduce(stubber)
			return given
        }
    ...
    public struct Verify {
        ...
        public static func execute(page: Parameter<Int>) -> Verify { return Verify(method: .m_execute__page_page(`page`))}
    }
    ...
    public struct Perform {
        ...
        public static func execute(page: Parameter<Int>, perform: @escaping (Int) -> Void) -> Perform {
            return Perform(method: .m_execute__page_page(`page`), performs: perform)
        }
    }
...
open class FeaturedArticleRepositoryMock: FeaturedArticleRepository, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func requestFeaturedArticleDataList() -> Single<FeaturedArticleAPIResponse> {
        addInvocation(.m_requestFeaturedArticleDataList)
		let perform = methodPerformValue(.m_requestFeaturedArticleDataList) as? () -> Void
		perform?()
		var __value: Single<FeaturedArticleAPIResponse>
		do {
		    __value = try methodReturnValue(.m_requestFeaturedArticleDataList).casted()
		} catch {
			onFatalFailure("Stub return value not specified for requestFeaturedArticleDataList(). Use given")
			Failure("Stub return value not specified for requestFeaturedArticleDataList(). Use given")
		}
		return __value
    }
    ...
    fileprivate enum MethodType {
        case m_requestFeaturedArticleDataList

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_requestFeaturedArticleDataList, .m_requestFeaturedArticleDataList): return .match
            }
        }

        func intValue() -> Int {
            switch self {
            case .m_requestFeaturedArticleDataList: return 0
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_requestFeaturedArticleDataList: return ".requestFeaturedArticleDataList()"
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func requestFeaturedArticleDataList(willReturn: Single<FeaturedArticleAPIResponse>...) -> MethodStub {
            return Given(method: .m_requestFeaturedArticleDataList, products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func requestFeaturedArticleDataList(willProduce: (Stubber<Single<FeaturedArticleAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<FeaturedArticleAPIResponse>] = []
			let given: Given = { return Given(method: .m_requestFeaturedArticleDataList, products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<FeaturedArticleAPIResponse>).self)
			willProduce(stubber)
			return given
        }
    ...
    public struct Verify {
        ...
        public static func requestFeaturedArticleDataList() -> Verify { return Verify(method: .m_requestFeaturedArticleDataList)}
    }
    ...
    public struct Perform {
        ...
        public static func requestFeaturedArticleDataList(perform: @escaping () -> Void) -> Perform {
            return Perform(method: .m_requestFeaturedArticleDataList, performs: perform)
        }
    }
...
// MARK: - FeaturedArticleUseCase

open class FeaturedArticleUseCaseMock: FeaturedArticleUseCase, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func execute() -> Single<FeaturedArticleAPIResponse> {
        addInvocation(.m_execute)
		let perform = methodPerformValue(.m_execute) as? () -> Void
		perform?()
		var __value: Single<FeaturedArticleAPIResponse>
    ...
    open class Given: StubbedMethod {
        ...
        public static func execute(willReturn: Single<FeaturedArticleAPIResponse>...) -> MethodStub {
            return Given(method: .m_execute, products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func execute(willProduce: (Stubber<Single<FeaturedArticleAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<FeaturedArticleAPIResponse>] = []
			let given: Given = { return Given(method: .m_execute, products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<FeaturedArticleAPIResponse>).self)
			willProduce(stubber)
...
open class ItemRepositoryMock: ItemRepository, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func requestItemDataList(page: Int) -> Single<ItemAPIResponse> {
        addInvocation(.m_requestItemDataList__page_page(Parameter<Int>.value(`page`)))
		let perform = methodPerformValue(.m_requestItemDataList__page_page(Parameter<Int>.value(`page`))) as? (Int) -> Void
		perform?(`page`)
		var __value: Single<ItemAPIResponse>
		do {
		    __value = try methodReturnValue(.m_requestItemDataList__page_page(Parameter<Int>.value(`page`))).casted()
		} catch {
			onFatalFailure("Stub return value not specified for requestItemDataList(page: Int). Use given")
			Failure("Stub return value not specified for requestItemDataList(page: Int). Use given")
		}
		return __value
    }
    ...
    fileprivate enum MethodType {
        case m_requestItemDataList__page_page(Parameter<Int>)

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_requestItemDataList__page_page(let lhsPage), .m_requestItemDataList__page_page(let rhsPage)):
				var results: [Matcher.ParameterComparisonResult] = []
				results.append(Matcher.ParameterComparisonResult(Parameter.compare(lhs: lhsPage, rhs: rhsPage, with: matcher), lhsPage, rhsPage, "page"))
				return Matcher.ComparisonResult(results)
            }
        ...
        func intValue() -> Int {
            switch self {
            case let .m_requestItemDataList__page_page(p0): return p0.intValue
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_requestItemDataList__page_page: return ".requestItemDataList(page:)"
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func requestItemDataList(page: Parameter<Int>, willReturn: Single<ItemAPIResponse>...) -> MethodStub {
            return Given(method: .m_requestItemDataList__page_page(`page`), products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func requestItemDataList(page: Parameter<Int>, willProduce: (Stubber<Single<ItemAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<ItemAPIResponse>] = []
			let given: Given = { return Given(method: .m_requestItemDataList__page_page(`page`), products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<ItemAPIResponse>).self)
			willProduce(stubber)
			return given
        }
    ...
    public struct Verify {
        ...
        public static func requestItemDataList(page: Parameter<Int>) -> Verify { return Verify(method: .m_requestItemDataList__page_page(`page`))}
    }
    ...
    public struct Perform {
        ...
        public static func requestItemDataList(page: Parameter<Int>, perform: @escaping (Int) -> Void) -> Perform {
            return Perform(method: .m_requestItemDataList__page_page(`page`), performs: perform)
        }
    }
...
open class ItemUseCaseMock: ItemUseCase, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func execute(page: Int) -> Single<ItemAPIResponse> {
        addInvocation(.m_execute__page_page(Parameter<Int>.value(`page`)))
		let perform = methodPerformValue(.m_execute__page_page(Parameter<Int>.value(`page`))) as? (Int) -> Void
		perform?(`page`)
		var __value: Single<ItemAPIResponse>
    ...
    open class Given: StubbedMethod {
        ...
        public static func execute(page: Parameter<Int>, willReturn: Single<ItemAPIResponse>...) -> MethodStub {
            return Given(method: .m_execute__page_page(`page`), products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func execute(page: Parameter<Int>, willProduce: (Stubber<Single<ItemAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<ItemAPIResponse>] = []
			let given: Given = { return Given(method: .m_execute__page_page(`page`), products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<ItemAPIResponse>).self)
			willProduce(stubber)
...
// MARK: - RecentAnnouncementUseCase

open class RecentAnnouncementUseCaseMock: RecentAnnouncementUseCase, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func execute() -> Single<AnnouncementDetailAPIResponse> {
        addInvocation(.m_execute)
		let perform = methodPerformValue(.m_execute) as? () -> Void
		perform?()
		var __value: Single<AnnouncementDetailAPIResponse>
    ...
    open class Given: StubbedMethod {
        ...
        public static func execute(willReturn: Single<AnnouncementDetailAPIResponse>...) -> MethodStub {
            return Given(method: .m_execute, products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func execute(willProduce: (Stubber<Single<AnnouncementDetailAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<AnnouncementDetailAPIResponse>] = []
			let given: Given = { return Given(method: .m_execute, products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<AnnouncementDetailAPIResponse>).self)
			willProduce(stubber)
...
open class StoryRepositoryMock: StoryRepository, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func requestStoryDataList() -> Single<StoryAPIResponse> {
        addInvocation(.m_requestStoryDataList)
		let perform = methodPerformValue(.m_requestStoryDataList) as? () -> Void
		perform?()
		var __value: Single<StoryAPIResponse>
		do {
		    __value = try methodReturnValue(.m_requestStoryDataList).casted()
		} catch {
			onFatalFailure("Stub return value not specified for requestStoryDataList(). Use given")
			Failure("Stub return value not specified for requestStoryDataList(). Use given")
		}
		return __value
    }
    ...
    fileprivate enum MethodType {
        case m_requestStoryDataList

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_requestStoryDataList, .m_requestStoryDataList): return .match
            }
        }

        func intValue() -> Int {
            switch self {
            case .m_requestStoryDataList: return 0
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_requestStoryDataList: return ".requestStoryDataList()"
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func requestStoryDataList(willReturn: Single<StoryAPIResponse>...) -> MethodStub {
            return Given(method: .m_requestStoryDataList, products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func requestStoryDataList(willProduce: (Stubber<Single<StoryAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<StoryAPIResponse>] = []
			let given: Given = { return Given(method: .m_requestStoryDataList, products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<StoryAPIResponse>).self)
			willProduce(stubber)
			return given
        }
    ...
    public struct Verify {
        ...
        public static func requestStoryDataList() -> Verify { return Verify(method: .m_requestStoryDataList)}
    }
    ...
    public struct Perform {
        ...
        public static func requestStoryDataList(perform: @escaping () -> Void) -> Perform {
            return Perform(method: .m_requestStoryDataList, performs: perform)
        }
    }
...
open class StoryUseCaseMock: StoryUseCase, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func execute() -> Single<StoryAPIResponse> {
        addInvocation(.m_execute)
		let perform = methodPerformValue(.m_execute) as? () -> Void
		perform?()
		var __value: Single<StoryAPIResponse>
    ...
    open class Given: StubbedMethod {
        ...
        public static func execute(willReturn: Single<StoryAPIResponse>...) -> MethodStub {
            return Given(method: .m_execute, products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func execute(willProduce: (Stubber<Single<StoryAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<StoryAPIResponse>] = []
			let given: Given = { return Given(method: .m_execute, products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<StoryAPIResponse>).self)
			willProduce(stubber)
...
open class TopBannerRepositoryMock: TopBannerRepository, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func requestTopBannerDataList() -> Single<TopBannerAPIResponse> {
        addInvocation(.m_requestTopBannerDataList)
		let perform = methodPerformValue(.m_requestTopBannerDataList) as? () -> Void
		perform?()
		var __value: Single<TopBannerAPIResponse>
		do {
		    __value = try methodReturnValue(.m_requestTopBannerDataList).casted()
		} catch {
			onFatalFailure("Stub return value not specified for requestTopBannerDataList(). Use given")
			Failure("Stub return value not specified for requestTopBannerDataList(). Use given")
		}
		return __value
    }
    ...
    fileprivate enum MethodType {
        case m_requestTopBannerDataList

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_requestTopBannerDataList, .m_requestTopBannerDataList): return .match
            }
        }

        func intValue() -> Int {
            switch self {
            case .m_requestTopBannerDataList: return 0
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_requestTopBannerDataList: return ".requestTopBannerDataList()"
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func requestTopBannerDataList(willReturn: Single<TopBannerAPIResponse>...) -> MethodStub {
            return Given(method: .m_requestTopBannerDataList, products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func requestTopBannerDataList(willProduce: (Stubber<Single<TopBannerAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<TopBannerAPIResponse>] = []
			let given: Given = { return Given(method: .m_requestTopBannerDataList, products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<TopBannerAPIResponse>).self)
			willProduce(stubber)
			return given
        }
    ...
    public struct Verify {
        ...
        public static func requestTopBannerDataList() -> Verify { return Verify(method: .m_requestTopBannerDataList)}
    }
    ...
    public struct Perform {
        ...
        public static func requestTopBannerDataList(perform: @escaping () -> Void) -> Perform {
            return Perform(method: .m_requestTopBannerDataList, performs: perform)
        }
    }
...
open class TopBannerUseCaseMock: TopBannerUseCase, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func execute() -> Single<TopBannerAPIResponse> {
        addInvocation(.m_execute)
		let perform = methodPerformValue(.m_execute) as? () -> Void
		perform?()
		var __value: Single<TopBannerAPIResponse>
    ...
    open class Given: StubbedMethod {
        ...
        public static func execute(willReturn: Single<TopBannerAPIResponse>...) -> MethodStub {
            return Given(method: .m_execute, products: willReturn.map({ StubProduct.return($0 as Any) }))
        }
        public static func execute(willProduce: (Stubber<Single<TopBannerAPIResponse>>) -> Void) -> MethodStub {
            let willReturn: [Single<TopBannerAPIResponse>] = []
			let given: Given = { return Given(method: .m_execute, products: willReturn.map({ StubProduct.return($0 as Any) })) }()
			let stubber = given.stub(for: (Single<TopBannerAPIResponse>).self)
			willProduce(stubber)
