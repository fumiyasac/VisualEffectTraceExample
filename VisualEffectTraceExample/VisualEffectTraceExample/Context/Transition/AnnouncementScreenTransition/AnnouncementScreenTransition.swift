//
//  AnnouncementScreenTransition.swift
...
final class AnnouncementScreenTransition: NSObject {
    ...
    // アニメーションと対象なるViewControllerの位置やサイズ情報を格納するメンバ変数
    var originalFrame: CGRect = CGRect.zero
}

// MARK: - UIViewControllerAnimatedTransitioning

extension AnnouncementScreenTransition: UIViewControllerAnimatedTransitioning {
