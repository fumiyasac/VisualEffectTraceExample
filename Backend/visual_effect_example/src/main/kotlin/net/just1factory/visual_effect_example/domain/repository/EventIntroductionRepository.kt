...
@Repository
interface EventIntroductionRepository :JpaRepository<EventIntroductionEntity, Int> {
	...
	@Query(value = "SELECT * FROM event_introductions ORDER BY id DESC LIMIT :limit OFFSET :offset" , nativeQuery = true)
	fun selectEventIntroductionPerPage(@Param("limit") limit: Int, @Param("offset") offset: Int): List<EventIntroductionEntity>
}
